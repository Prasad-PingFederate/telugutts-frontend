...
class handler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        try:
            ...
            async def generate_audio():
                # Use Edge TTS with rate and pitch parameters (NOT raw SSML)
                # This prevents tags from being read aloud
            ...
            response = {
                ...
                'message': 'Male voice generated successfully'
            }
    ...
    def improve_text_naturalness(self, text):
        ...
        NO SSML tags - they get read aloud!
        """
